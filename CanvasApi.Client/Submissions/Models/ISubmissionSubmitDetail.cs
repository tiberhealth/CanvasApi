...
namespace CanvasApi.Client.Submissions.Models
{
    public interface ISubmissionSubmitDetail
    {
        ...
        /// </summary>
        [Multipart("submission_type")] SubmissionTypes SubmissionType { get; set; }
        ...
        /// </summary>
        [Multipart("file_ids")] IEnumerable<long> FileIds { get; set; }
        ...
        /// </summary>
        [Multipart("media_comment_id")] string MediaCommentId { get; set; }
        ...
        /// audio, video
        /// </summary>
        [Multipart("media_comment_type")] MediaCommentTypes? MediaCommentType { get; set; }
        ...
        /// </summary>
        [Multipart("submitted_at")] DateTime? SubmittedAt { get; set; }
    }
}
