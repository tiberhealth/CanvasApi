...
namespace CanvasApi.Client.Submissions.Models
{
    public interface ISubmissionSubmitDetail
    {
        ...
        /// </summary>
        [JsonProperty("submission_type")] SubmissionTypes SubmissionType { get; set; }
        ...
        /// </summary>
        [JsonProperty("file_ids")] IEnumerable<long> FileIds { get; set; }
        ...
        /// </summary>
        [JsonProperty("media_comment_id")] string MediaCommentId { get; set; }
        ...
        /// audio, video
        /// </summary>
        [JsonProperty("media_comment_type")] MediaCommentTypes? MediaCommentType { get; set; }
        ...
        /// </summary>
        [JsonProperty("submitted_at")] DateTime? SubmittedAt { get; set; }
    }
}
